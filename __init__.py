...
bl_info = {
    "name": "Batch UV Rename",
    "description": "Utility to iteratively rename UV Maps",
    "author": "Bogdan",
    "version": (1, 0),
    "blender": (3, 6, 0),
    "location": "Object Data Properties > UV Maps",
    "category": "UV",
}
...
from .batch_rename import OT_BatchRenameUV, batch_rename_ui
